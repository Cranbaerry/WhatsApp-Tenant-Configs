	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.callback_url LIKE ' . $search . '  OR  a.forward_url LIKE ' . $search . '  OR  a.app_id LIKE ' . $search . '  OR  a.token LIKE ' . $search . '  OR  a.phone_number LIKE ' . $search . '  OR  a.user_id LIKE ' . $search . '  OR  a.business_account_id LIKE ' . $search . ' )');
			}
		}
